    ...
    decode_head=dict(
        ...
        ood_cfg=dict(
            ...
            class_groups_variants=dict(
                m3_vno=[[0, 1, 2, 3, 4, 20, 21, 22, 7, 8, 18, 23], [5, 6],
                        [9, 10, 11, 19], [12, 13, 14, 15, 16, 17]],
                m3_hgc=[[5, 6, 9, 10, 11, 19, 12, 13, 14, 15, 16, 17],
                        [0, 1, 2, 3, 4], [20, 21, 22], [7, 8, 18, 23]],
                m3_hgn=[[5, 6, 9, 10, 11, 19, 20, 21, 22], [0, 1, 2, 3, 4],
                        [12, 13, 14, 15, 16, 17], [7, 8, 18, 23]],
                m3_hgo=[[5, 6, 9, 10, 11, 19, 7, 8, 18, 23], [0, 1, 2, 3, 4],
                        [12, 13, 14, 15, 16, 17], [20, 21, 22]],
                m3_hcn=[[5, 6, 12, 13, 14, 15, 16, 17, 20, 21, 22],
                        [0, 1, 2, 3, 4], [9, 10, 11, 19], [7, 8, 18, 23]],
                m3_hco=[[5, 6, 12, 13, 14, 15, 16, 17, 7, 8, 18, 23],
                        [0, 1, 2, 3, 4], [9, 10, 11, 19], [20, 21, 22]],
                m3_hno=[[5, 6, 20, 21, 22, 7, 8, 18, 23], [0, 1, 2, 3, 4],
                        [9, 10, 11, 19], [12, 13, 14, 15, 16, 17]],
                m3_gcn=[[9, 10, 11, 19, 12, 13, 14, 15, 16, 17, 20, 21, 22],
                        [0, 1, 2, 3, 4], [5, 6], [7, 8, 18, 23]],
                m3_gco=[[9, 10, 11, 19, 12, 13, 14, 15, 16, 17, 7, 8, 18, 23],
                        [0, 1, 2, 3, 4], [5, 6], [20, 21, 22]],
                m3_gno=[[9, 10, 11, 19, 20, 21, 22, 7, 8, 18, 23],
                        [0, 1, 2, 3, 4], [5, 6], [12, 13, 14, 15, 16, 17]],
                m3_cno=[[12, 13, 14, 15, 16, 17, 20, 21, 22, 7, 8, 18, 23],
                        [0, 1, 2, 3, 4], [5, 6], [9, 10, 11, 19]],
                m4_vhgc=[[
                    0, 1, 2, 3, 4, 5, 6, 9, 10, 11, 19, 12, 13, 14, 15, 16, 17
                ], [20, 21, 22], [7, 8, 18, 23]]))),
    train_cfg=None,
...
launcher = 'none'
work_dir = 'work_dirs/p3former_2xb1_3x_dso_ood_hier/b3'
