    ...
    decode_head=dict(
        ...
        ood_cfg=dict(
            ...
            class_groups_variants=dict(
                m2_cn=[[12, 13, 14, 15, 16, 17, 20, 21, 22], [0, 1, 2, 3, 4],
                       [5, 6], [9, 10, 11, 19], [7, 8, 18, 23]],
                m2_co=[[12, 13, 14, 15, 16, 17, 7, 8, 18, 23], [0, 1, 2, 3, 4],
                       [5, 6], [9, 10, 11, 19], [20, 21, 22]],
                m2_no=[[20, 21, 22, 7, 8, 18, 23], [0, 1, 2, 3, 4], [5, 6],
                       [9, 10, 11, 19], [12, 13, 14, 15, 16, 17]],
                m3_vhg=[[0, 1, 2, 3, 4, 5, 6, 9, 10, 11, 19],
                        [12, 13, 14, 15, 16, 17], [20, 21, 22], [7, 8, 18,
                                                                 23]],
                m3_vhc=[[0, 1, 2, 3, 4, 5, 6, 12, 13, 14, 15, 16, 17],
                        [9, 10, 11, 19], [20, 21, 22], [7, 8, 18, 23]],
                m3_vhn=[[0, 1, 2, 3, 4, 5, 6, 20, 21, 22], [9, 10, 11, 19],
                        [12, 13, 14, 15, 16, 17], [7, 8, 18, 23]],
                m3_vho=[[0, 1, 2, 3, 4, 5, 6, 7, 8, 18, 23], [9, 10, 11, 19],
                        [12, 13, 14, 15, 16, 17], [20, 21, 22]],
                m3_vgc=[[0, 1, 2, 3, 4, 9, 10, 11, 19, 12, 13, 14, 15, 16, 17],
                        [5, 6], [20, 21, 22], [7, 8, 18, 23]],
                m3_vgn=[[0, 1, 2, 3, 4, 9, 10, 11, 19, 20, 21, 22], [5, 6],
                        [12, 13, 14, 15, 16, 17], [7, 8, 18, 23]],
                m3_vgo=[[0, 1, 2, 3, 4, 9, 10, 11, 19, 7, 8, 18, 23], [5, 6],
                        [12, 13, 14, 15, 16, 17], [20, 21, 22]],
                m3_vcn=[[0, 1, 2, 3, 4, 12, 13, 14, 15, 16, 17, 20, 21, 22],
                        [5, 6], [9, 10, 11, 19], [7, 8, 18, 23]],
                m3_vco=[[0, 1, 2, 3, 4, 12, 13, 14, 15, 16, 17, 7, 8, 18, 23],
                        [5, 6], [9, 10, 11, 19], [20, 21, 22]]))),
    train_cfg=None,
...
launcher = 'none'
work_dir = 'work_dirs/p3former_2xb1_3x_dso_ood_hier/b2'
