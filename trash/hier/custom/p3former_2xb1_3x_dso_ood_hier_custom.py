    ...
    decode_head=dict(
        ...
        ood_cfg=dict(
            ...
            class_groups_variants=dict(
                p_vh_gcno=[[0, 1, 2, 3, 4, 5, 6],
                           [
                               9, 10, 11, 19, 12, 13, 14, 15, 16, 17, 20, 21,
                               22, 7, 8, 18, 23
                           ]],
                p_vh_gn_co=[[0, 1, 2, 3, 4, 5, 6], [9, 10, 11, 19, 20, 21, 22],
...
launcher = 'none'
work_dir = 'work_dirs/p3former_2xb1_3x_dso_ood_hier/custom'
