    ...
    decode_head=dict(
        ...
        ood_cfg=dict(
            ...
            class_groups_variants=dict(
                m2_vh=[[0, 1, 2, 3, 4, 5, 6], [9, 10, 11, 19],
                       [12, 13, 14, 15, 16, 17], [20, 21, 22], [7, 8, 18, 23]],
                m2_vg=[[0, 1, 2, 3, 4, 9, 10, 11, 19], [5, 6],
                       [12, 13, 14, 15, 16, 17], [20, 21, 22], [7, 8, 18, 23]],
                m2_vc=[[0, 1, 2, 3, 4, 12, 13, 14, 15, 16, 17], [5, 6],
                       [9, 10, 11, 19], [20, 21, 22], [7, 8, 18, 23]],
                m2_vn=[[0, 1, 2, 3, 4, 20, 21, 22], [5, 6], [9, 10, 11, 19],
                       [12, 13, 14, 15, 16, 17], [7, 8, 18, 23]],
                m2_vo=[[0, 1, 2, 3, 4, 7, 8, 18, 23], [5, 6], [9, 10, 11, 19],
                       [12, 13, 14, 15, 16, 17], [20, 21, 22]],
                m2_hg=[[5, 6, 9, 10, 11, 19], [0, 1, 2, 3, 4],
                       [12, 13, 14, 15, 16, 17], [20, 21, 22], [7, 8, 18, 23]],
                m2_hc=[[5, 6, 12, 13, 14, 15, 16, 17], [0, 1, 2, 3, 4],
                       [9, 10, 11, 19], [20, 21, 22], [7, 8, 18, 23]],
                m2_hn=[[5, 6, 20, 21, 22], [0, 1, 2, 3, 4], [9, 10, 11, 19],
                       [12, 13, 14, 15, 16, 17], [7, 8, 18, 23]],
                m2_ho=[[5, 6, 7, 8, 18, 23], [0, 1, 2, 3, 4], [9, 10, 11, 19],
                       [12, 13, 14, 15, 16, 17], [20, 21, 22]],
                m2_gc=[[9, 10, 11, 19, 12, 13, 14, 15, 16, 17],
                       [0, 1, 2, 3, 4], [5, 6], [20, 21, 22], [7, 8, 18, 23]],
                m2_gn=[[9, 10, 11, 19, 20, 21, 22], [0, 1, 2, 3, 4], [5, 6],
                       [12, 13, 14, 15, 16, 17], [7, 8, 18, 23]],
                m2_go=[[9, 10, 11, 19, 7, 8, 18, 23], [0, 1, 2, 3, 4], [5, 6],
                       [12, 13, 14, 15, 16, 17], [20, 21, 22]]))),
    train_cfg=None,
...
launcher = 'none'
work_dir = 'work_dirs/p3former_2xb1_3x_dso_ood_hier/b1'
